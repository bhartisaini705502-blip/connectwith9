<header class="bg-light pt-4" style="margin-top: -20px;">
    ...
    <img src="images/logo.png" alt="Logo" class="img-fluid" style="max-width: 120px; height: auto;">
</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm d-lg-none w-100" style="z-index: 999; margin-top: -20px; padding-top:10px;">
        <div class="container-fluid">
            <!-- Logo -->
            <a href="index.php" class="navbar-brand fw-bold text-primary">
    <img src="images/logo.png" alt="Logo" class="img-fluid" style="max-width: 120px; height: auto;">
