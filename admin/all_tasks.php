                ...
                <?php foreach ($tasks as $task) { ?>
                    <div class="task-card">
                        <div class="task-content">
                            <h5 class="task-title">
                                <a href="<?php echo ($task['is_lead'] === 'yes') ? 'lead_details.php' : 'task_details.php'; ?>?task_id=<?php echo $task['id']; ?>"
                                    class="task-link">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center mt-4">
                <li class="page-item <?php if ($page <= 1)
                    echo 'disabled'; ?>">
                    <a class="page-link" href="?page=<?php echo max(1, $page - 1); ?>" tabindex="-1">
                        </a>
                </li>
